...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Note: If backend is not connected, fallback to mock for demonstration
        ...
        <div className="h-screen flex items-center justify-center bg-slate-950 text-white p-6 relative overflow-hidden">
            ...
            >
                <div className="text-center mb-10">
                    ...
                    <p className="text-slate-400">Sign in to continue to Meetflow AI</p>
                </div>
                ...
                <p className="text-center text-slate-400 mt-8 text-sm">
                    Don't have an account? <Link to="/signup" className="text-brand-400 font-bold hover:underline">Sign up</Link>
                </p>
            </motion.div>
        </div>
    );
